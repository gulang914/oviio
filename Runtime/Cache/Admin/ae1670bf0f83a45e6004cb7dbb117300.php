                ...
                <form class="" action="<?php echo U('Admin/Nav/order');?>" method="post">
                    <table class="table table-striped table-bordered table-hover table-condensed">
                        ...
                        <?php if(is_array($data)): foreach($data as $key=>$v): ?><tr>
                                <td>
                                    <input class="input-medium" style="width:40px;height:25px;" type="text" name="<?php echo ($v['id']); ?>" value="<?php echo ($v['order_number']); ?>">
                                </td>
                                <td><?php echo ($v['_name']); ?></td>
                                <td><?php echo ($v['mca']); ?></td>
                                <td>
                                    <?php if(($v["_level"]) == "1"): ?><a href="javascript:;" navId="<?php echo ($v['id']); ?>" navName="<?php echo ($v['name']); ?>"  onclick="add_child(this)">添加子菜单</a> |<?php endif; ?>
                                    ...
                                    <a href="<?php echo U('Admin/Nav/delete',array('id'=>$v['id']));?>" class="ajax-get confirm">删除</a>
                                </td>
                    ...
                    <form id="bjy-form" class="form-inline" action="<?php echo U('Admin/Nav/add');?>" method="post">
                        ...
                        <table class="table table-striped table-bordered table-hover table-condensed">
                            ...
                            <tr>
                                <th>连接：</th>
                                <td>
                                    <input class="input-medium" type="text" name="mca"> 输入模块/控制器/方法即可 例如 Admin/ShowNav/index
                                </td>
                            </tr>
                            <tr>
                                <th>图标：</th>
