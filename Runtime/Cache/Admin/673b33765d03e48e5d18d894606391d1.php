            ...
            <div class="tab-content">
                <table class="table table-striped table-bordered table-hover table-condensed">
                    ...
                    <?php if(is_array($data)): foreach($data as $key=>$v): ?><tr>
                            ...
                            <td>
                                <?php if(($v["_level"]) <= "2"): ?><a href="javascript:;" ruleId="<?php echo ($v['id']); ?>" onclick="add_child(this)">添加子权限</a> |<?php endif; ?>
                                
                                <a href="javascript:;" ruleId="<?php echo ($v['id']); ?>" ruleName="<?php echo ($v['name']); ?>" ruleTitle="<?php echo ($v['title']); ?>" onclick="edit(this)">修改</a> |
                                <a href="<?php echo U('Admin/Rule/delete',array('id'=>$v['id']));?>" class="ajax-get confirm">删除</a>
                            </td>
                    ...
                    <form id="bjy-form" class="form-inline" action="<?php echo U('Admin/Rule/add');?>" method="post">
                        ...
                        <table class="table table-striped table-bordered table-hover table-condensed">
                            ...
                            <tr>
                                <th>权限：</th>
                                <td>
                                    <input class="input-medium" type="text" name="name"> 输入模块/控制器/方法即可 例如 Admin/ShowNav/index
                                </td>
                            </tr>
                            <tr>
                                <th></th>
