    ...
    <div class="col-xs-12">
        <div class="tabbable">
            <ul class="nav nav-tabs padding-12 tab-color-blue background-blue" id="myTab">
                <li class="active">
                    <a href="<?php echo U('Admin/Banner/index');?>">汽车品牌列表</a>
                </li>
                <li>
                    <a href="<?php echo U('Admin/Banner/add');?>">添加汽车品牌</a>
                </li>
            </ul>
            <div class="tab-content">
                <form action="<?php echo U('Admin/Banner/editsort');?>" method="post">
                    ...
                    <?php if(is_array($banner_list)): foreach($banner_list as $key=>$v): ?><tr>
                            ...
                            <td>
                                <a href="<?php echo U('Admin/Banner/edit',array('id'=>$v['id']));?>">修改</a>
                            </td>
                        </tr><?php endforeach; endif; ?>
                    <tr>
                        <td></td>
                        <td><input type="submit" class="btn btn-success" value="更新排序"></td>
                        <td></td>
                    </tr>
                </table>
                </form>
